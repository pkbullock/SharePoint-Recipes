...
.Synopsis
    ...
    Converts all recipe publishing pages from an on-premises server
...
param (
    ...
    [string]$TargetSitePartUrl = "PnPKatchup-OurRecipes",
    ...
    [string]$PageLayoutMappingFile = "custompagelayoutmapping-recipes.xml"
)
begin{
    ...
    # Recipe Page Content Type
    $contentTypeToFilter = "0x010100C568DB52D9D0A14D9B2FDCC96666E9F2007948130EC3DB064584E219954237AF3900242457EFB8B24247815D688C526CD44D009FD5781CA117DE4795277EF0F9BDE42F"
}
process {
    ...
    Foreach($page in $pages){
        ...
        if($page.FieldValues["ContentTypeId"].StringValue -eq $contentTypeToFilter){
